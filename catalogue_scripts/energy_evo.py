...
if __name__ == '__main__':
    ...
    parser.add_argument('--phase', type=str, default='', help='Phase to which select the data.')
    ...
    for i in range(0, len(args.model)):
        ...
        for ozyfile in ozyfiles:
            ...
            for e_var in args.var:
                try:
                    print(sim.galaxies[progind].energies[e_var+args.phase])
                    e = sim.galaxies[progind].energies[e_var+args.phase]
