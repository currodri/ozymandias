"""
This is a simple code that tracks the gas mass evolution of a particular galaxy across the set of 
snapshots selected.
...
if __name__ == '__main__':
    ...
    if args.NUT:
        args.ind = 'NUT'
    fig.savefig(os.getcwd()+'/gas_mass_evolution_'+str(args.ind)+'.png', format='png', dpi=200)
