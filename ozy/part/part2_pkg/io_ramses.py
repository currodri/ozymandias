...
def retrieve_vars(repository, myvars):
    ...
    """
    _part2_pkg.f90wrap_retrieve_vars(repository=repository, myvars=myvars._handle)
...
def check_lmax(ngridfile):
    ...
    """
    _part2_pkg.f90wrap_check_lmax(ngridfile=ngridfile)
...
def check_families(repository):
    ...
    """
    _part2_pkg.f90wrap_check_families(repository=repository)
...
def select_from_descriptor_ids(newvar, newid):
    ...
    """
    _part2_pkg.f90wrap_select_from_descriptor_ids(newvar=newvar, newid=newid)
...
def getvarvalue(self, dx, x, var, varname, value):
    ...
    """
    _part2_pkg.f90wrap_getvarvalue(reg=self._handle, dx=dx, x=x._handle, var=var, \
...
def init_amr_read(repository):
    ...
    """
    _part2_pkg.f90wrap_init_amr_read(repository=repository)
...
def get_cpu_map(self):
    ...
    """
    _part2_pkg.f90wrap_get_cpu_map(reg=self._handle)
...
def getpartvalue(self, part, var, value, dx=None):
    ...
    """
    _part2_pkg.f90wrap_getpartvalue(reg=self._handle, part=part._handle, var=var, \
...
def get_longint():
    ...
    """
    return _part2_pkg.f90wrap_io_ramses__get__longint()

def set_longint(longint):
    _part2_pkg.f90wrap_io_ramses__set__longint(longint)
