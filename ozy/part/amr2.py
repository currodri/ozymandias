...
class Part_Profiles(f90wrap.runtime.FortranModule):
    ...
    Defined at profiles_module.fpp lines 5-279
    ...
    def findbinpos(self, reg, distance, part, prof, ibin):
        ...
        Defined at profiles_module.fpp lines 45-61
        ...
        """
        _amr2.f90wrap_findbinpos(sim=self._handle, reg=reg._handle, distance=distance, \
    ...
    def bindata(self, reg, part, prof, ibin):
        ...
        Defined at profiles_module.fpp lines 63-92
        ...
        """
        _amr2.f90wrap_bindata(sim=self._handle, reg=reg._handle, part=part._handle, \
    ...
    def renormalise_bins(self):
        ...
        Defined at profiles_module.fpp lines 94-116
    ...
    def get_parts_onedprofile(repository, amr, sim, reg, filt, prof_data):
        ...
        Defined at profiles_module.fpp lines 118-256
        ...
        """
        _amr2.f90wrap_get_parts_onedprofile(repository=repository, amr=amr._handle, \
    ...
    def onedprofile(repository, reg, filt, prof_data, lmax):
        ...
        Defined at profiles_module.fpp lines 258-279
