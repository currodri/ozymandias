...
@f90wrap.runtime.register_class("amr2_pkg.vector")
class vector(f90wrap.runtime.FortranDerivedType):
    ...
    def __init__(self, handle=None):
        ...
        result = _amr2_pkg.f90wrap_vector_initialise()
    ...
    def __del__(self):
        ...
        """
        if self._alloc:
            _amr2_pkg.f90wrap_vector_finalise(this=self._handle)
    ...
    def x(self):
        ...
        """
        return _amr2_pkg.f90wrap_vector__get__x(self._handle)
    
    @x.setter
    def x(self, x):
        _amr2_pkg.f90wrap_vector__set__x(self._handle, x)
    ...
    def y(self):
        ...
        """
        return _amr2_pkg.f90wrap_vector__get__y(self._handle)
    
    @y.setter
    def y(self, y):
        _amr2_pkg.f90wrap_vector__set__y(self._handle, y)
    ...
    def z(self):
        ...
        """
        return _amr2_pkg.f90wrap_vector__get__z(self._handle)
    
    @z.setter
    def z(self, z):
        _amr2_pkg.f90wrap_vector__set__z(self._handle, z)
...
@f90wrap.runtime.register_class("amr2_pkg.array_vectors")
class array_vectors(f90wrap.runtime.FortranDerivedType):
    ...
    def __init__(self, handle=None):
        ...
        """
        f90wrap.runtime.FortranDerivedType.__init__(self)
        result = _amr2_pkg.f90wrap_array_vectors_initialise()
        self._handle = result[0] if isinstance(result, tuple) else result
    ...
    def __del__(self):
        ...
        """
        if self._alloc:
            _amr2_pkg.f90wrap_array_vectors_finalise(this=self._handle)
    ...
    def n(self):
        ...
        """
        return _amr2_pkg.f90wrap_array_vectors__get__n(self._handle)
    
    @n.setter
    def n(self, n):
        _amr2_pkg.f90wrap_array_vectors__set__n(self._handle, n)
    
    def init_array_list(self):
        self.list = f90wrap.runtime.FortranDerivedTypeArray(self,
                                        _amr2_pkg.f90wrap_array_vectors__array_getitem__list,
                                        _amr2_pkg.f90wrap_array_vectors__array_setitem__list,
                                        _amr2_pkg.f90wrap_array_vectors__array_len__list,
                                        """
...
def magnitude(self):
    ...
    """
    magnitude = _amr2_pkg.f90wrap_magnitude(vec_1=self._handle)
    return magnitude
...
def _array_to_vector(self, array):
    ...
    """
    _amr2_pkg.f90wrap_array_to_vector(vec_result=self._handle, array=array)
...
def _vector_to_array(array_result, vec_1):
    ...
    """
    _amr2_pkg.f90wrap_vector_to_array(array_result=array_result, \
        vec_1=vec_1._handle)
