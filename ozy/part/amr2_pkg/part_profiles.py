...
def findbinpos(self, reg, distance, part, prof, ibin):
    ...
    """
    _amr2_pkg.f90wrap_findbinpos(sim=self._handle, reg=reg._handle, \
...
def bindata(self, reg, part, prof, ibin):
    ...
    """
    _amr2_pkg.f90wrap_bindata(sim=self._handle, reg=reg._handle, part=part._handle, \
...
def get_parts_onedprofile(repository, amr, sim, reg, filt, prof_data):
    ...
    """
    _amr2_pkg.f90wrap_get_parts_onedprofile(repository=repository, amr=amr._handle, \
