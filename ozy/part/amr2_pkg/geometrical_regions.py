...
@f90wrap.runtime.register_class("amr2_pkg.region")
class region(f90wrap.runtime.FortranDerivedType):
    ...
    def __init__(self, handle=None):
        ...
        result = _amr2_pkg.f90wrap_region_initialise()
    ...
    def __del__(self):
        ...
        """
        if self._alloc:
            _amr2_pkg.f90wrap_region_finalise(this=self._handle)
    ...
    def name(self):
        ...
        """
        return _amr2_pkg.f90wrap_region__get__name(self._handle)
    
    @name.setter
    def name(self, name):
        _amr2_pkg.f90wrap_region__set__name(self._handle, name)
    ...
    def centre(self):
        ...
        """
        centre_handle = _amr2_pkg.f90wrap_region__get__centre(self._handle)
    ...
    def centre(self, centre):
        ...
        _amr2_pkg.f90wrap_region__set__centre(self._handle, centre)
    ...
    def axis(self):
        ...
        """
        axis_handle = _amr2_pkg.f90wrap_region__get__axis(self._handle)
    ...
    def axis(self, axis):
        axis = axis._handle
        _amr2_pkg.f90wrap_region__set__axis(self._handle, axis)
    ...
    def bulk_velocity(self):
        ...
        bulk_velocity_handle = \
            _amr2_pkg.f90wrap_region__get__bulk_velocity(self._handle)
    ...
    def bulk_velocity(self, bulk_velocity):
        ...
        _amr2_pkg.f90wrap_region__set__bulk_velocity(self._handle, bulk_velocity)
    ...
    def xmin(self):
        ...
        """
        return _amr2_pkg.f90wrap_region__get__xmin(self._handle)
    
    @xmin.setter
    def xmin(self, xmin):
        _amr2_pkg.f90wrap_region__set__xmin(self._handle, xmin)
    ...
    def xmax(self):
        ...
        """
        return _amr2_pkg.f90wrap_region__get__xmax(self._handle)
    
    @xmax.setter
    def xmax(self, xmax):
        _amr2_pkg.f90wrap_region__set__xmax(self._handle, xmax)
    ...
    def ymin(self):
        ...
        """
        return _amr2_pkg.f90wrap_region__get__ymin(self._handle)
    
    @ymin.setter
    def ymin(self, ymin):
        _amr2_pkg.f90wrap_region__set__ymin(self._handle, ymin)
    ...
    def ymax(self):
        ...
        """
        return _amr2_pkg.f90wrap_region__get__ymax(self._handle)
    
    @ymax.setter
    def ymax(self, ymax):
        _amr2_pkg.f90wrap_region__set__ymax(self._handle, ymax)
    ...
    def zmin(self):
        ...
        """
        return _amr2_pkg.f90wrap_region__get__zmin(self._handle)
    
    @zmin.setter
    def zmin(self, zmin):
        _amr2_pkg.f90wrap_region__set__zmin(self._handle, zmin)
    ...
    def zmax(self):
        ...
        """
        return _amr2_pkg.f90wrap_region__get__zmax(self._handle)
    
    @zmax.setter
    def zmax(self, zmax):
        _amr2_pkg.f90wrap_region__set__zmax(self._handle, zmax)
    ...
    def rmin(self):
        ...
        """
        return _amr2_pkg.f90wrap_region__get__rmin(self._handle)
    
    @rmin.setter
    def rmin(self, rmin):
        _amr2_pkg.f90wrap_region__set__rmin(self._handle, rmin)
    ...
    def rmax(self):
        ...
        """
        return _amr2_pkg.f90wrap_region__get__rmax(self._handle)
    
    @rmax.setter
    def rmax(self, rmax):
        _amr2_pkg.f90wrap_region__set__rmax(self._handle, rmax)
    ...
    def angle(self):
        ...
        """
        return _amr2_pkg.f90wrap_region__get__angle(self._handle)
    
    @angle.setter
    def angle(self, angle):
        _amr2_pkg.f90wrap_region__set__angle(self._handle, angle)
    ...
    def criteria_name(self):
        ...
        """
        return _amr2_pkg.f90wrap_region__get__criteria_name(self._handle)
    
    @criteria_name.setter
    def criteria_name(self, criteria_name):
        _amr2_pkg.f90wrap_region__set__criteria_name(self._handle, criteria_name)
...
def limits(self, lim):
    ...
    """
    _amr2_pkg.f90wrap_limits(reg=self._handle, lim=lim)
...
def checkifinside(pos, reg, ok, distance):
    ...
    """
    _amr2_pkg.f90wrap_checkifinside(pos=pos, reg=reg._handle, ok=ok, \
        distance=distance)
...
def cube(self, reg, ok, distance):
    ...
    """
    _amr2_pkg.f90wrap_cube(p=self._handle, reg=reg._handle, ok=ok, \
        distance=distance)
...
def sphere(self, reg, ok, distance):
    ...
    """
    _amr2_pkg.f90wrap_sphere(p=self._handle, reg=reg._handle, ok=ok, \
        distance=distance)
...
def cylinder(self, reg, ok, distance):
    ...
    """
    _amr2_pkg.f90wrap_cylinder(p=self._handle, reg=reg._handle, ok=ok, \
        distance=distance)
...
def cone(self, reg, ok, distance):
    ...
    """
    _amr2_pkg.f90wrap_cone(p=self._handle, reg=reg._handle, ok=ok, \
        distance=distance)
