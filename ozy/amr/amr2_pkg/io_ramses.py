...
Defined at read_amr_module.fpp lines 24-1341
...
@f90wrap.runtime.register_class("amr2_pkg.hydroID")
class hydroID(f90wrap.runtime.FortranDerivedType):
    ...
    def __init__(self, handle=None):
        ...
        result = _amr2_pkg.f90wrap_hydroid_initialise()
    ...
    def __del__(self):
        ...
        """
        if self._alloc:
            _amr2_pkg.f90wrap_hydroid_finalise(this=self._handle)
    ...
    def nvar(self):
        ...
        """
        return _amr2_pkg.f90wrap_hydroid__get__nvar(self._handle)
    
    @nvar.setter
    def nvar(self, nvar):
        _amr2_pkg.f90wrap_hydroid__set__nvar(self._handle, nvar)
    ...
    def density(self):
        ...
        """
        return _amr2_pkg.f90wrap_hydroid__get__density(self._handle)
    
    @density.setter
    def density(self, density):
        _amr2_pkg.f90wrap_hydroid__set__density(self._handle, density)
    ...
    def vx(self):
        ...
        """
        return _amr2_pkg.f90wrap_hydroid__get__vx(self._handle)
    
    @vx.setter
    def vx(self, vx):
        _amr2_pkg.f90wrap_hydroid__set__vx(self._handle, vx)
    ...
    def vy(self):
        ...
        """
        return _amr2_pkg.f90wrap_hydroid__get__vy(self._handle)
    
    @vy.setter
    def vy(self, vy):
        _amr2_pkg.f90wrap_hydroid__set__vy(self._handle, vy)
    ...
    def vz(self):
        ...
        """
        return _amr2_pkg.f90wrap_hydroid__get__vz(self._handle)
    
    @vz.setter
    def vz(self, vz):
        _amr2_pkg.f90wrap_hydroid__set__vz(self._handle, vz)
    ...
    def thermal_pressure(self):
        ...
        """
        return _amr2_pkg.f90wrap_hydroid__get__thermal_pressure(self._handle)
    
    @thermal_pressure.setter
    def thermal_pressure(self, thermal_pressure):
        _amr2_pkg.f90wrap_hydroid__set__thermal_pressure(self._handle, thermal_pressure)
    ...
    def metallicity(self):
        ...
        """
        return _amr2_pkg.f90wrap_hydroid__get__metallicity(self._handle)
    
    @metallicity.setter
    def metallicity(self, metallicity):
        _amr2_pkg.f90wrap_hydroid__set__metallicity(self._handle, metallicity)
    ...
    def blx(self):
        ...
        """
        return _amr2_pkg.f90wrap_hydroid__get__blx(self._handle)
    
    @blx.setter
    def blx(self, blx):
        _amr2_pkg.f90wrap_hydroid__set__blx(self._handle, blx)
    ...
    def bly(self):
        ...
        """
        return _amr2_pkg.f90wrap_hydroid__get__bly(self._handle)
    
    @bly.setter
    def bly(self, bly):
        _amr2_pkg.f90wrap_hydroid__set__bly(self._handle, bly)
    ...
    def blz(self):
        ...
        """
        return _amr2_pkg.f90wrap_hydroid__get__blz(self._handle)
    
    @blz.setter
    def blz(self, blz):
        _amr2_pkg.f90wrap_hydroid__set__blz(self._handle, blz)
    ...
    def brx(self):
        ...
        """
        return _amr2_pkg.f90wrap_hydroid__get__brx(self._handle)
    
    @brx.setter
    def brx(self, brx):
        _amr2_pkg.f90wrap_hydroid__set__brx(self._handle, brx)
    ...
    def bry(self):
        ...
        """
        return _amr2_pkg.f90wrap_hydroid__get__bry(self._handle)
    
    @bry.setter
    def bry(self, bry):
        _amr2_pkg.f90wrap_hydroid__set__bry(self._handle, bry)
    ...
    def brz(self):
        ...
        """
        return _amr2_pkg.f90wrap_hydroid__get__brz(self._handle)
    
    @brz.setter
    def brz(self, brz):
        _amr2_pkg.f90wrap_hydroid__set__brz(self._handle, brz)
    ...
    def cr_pressure(self):
        ...
        """
        return _amr2_pkg.f90wrap_hydroid__get__cr_pressure(self._handle)
    
    @cr_pressure.setter
    def cr_pressure(self, cr_pressure):
        _amr2_pkg.f90wrap_hydroid__set__cr_pressure(self._handle, cr_pressure)
    ...
    def xhii(self):
        ...
        """
        return _amr2_pkg.f90wrap_hydroid__get__xhii(self._handle)
    
    @xhii.setter
    def xhii(self, xhii):
        _amr2_pkg.f90wrap_hydroid__set__xhii(self._handle, xhii)
    ...
    def xheii(self):
        ...
        """
        return _amr2_pkg.f90wrap_hydroid__get__xheii(self._handle)
    
    @xheii.setter
    def xheii(self, xheii):
        _amr2_pkg.f90wrap_hydroid__set__xheii(self._handle, xheii)
    ...
    def xheiii(self):
        ...
        """
        return _amr2_pkg.f90wrap_hydroid__get__xheiii(self._handle)
    
    @xheiii.setter
    def xheiii(self, xheiii):
        _amr2_pkg.f90wrap_hydroid__set__xheiii(self._handle, xheiii)
...
@f90wrap.runtime.register_class("amr2_pkg.amr_info")
class amr_info(f90wrap.runtime.FortranDerivedType):
    ...
    def __init__(self, handle=None):
        ...
        """
        f90wrap.runtime.FortranDerivedType.__init__(self)
        result = _amr2_pkg.f90wrap_amr_info_initialise()
        self._handle = result[0] if isinstance(result, tuple) else result
    ...
    def __del__(self):
        ...
        """
        if self._alloc:
            _amr2_pkg.f90wrap_amr_info_finalise(this=self._handle)
    ...
    def ncpu(self):
        ...
        """
        return _amr2_pkg.f90wrap_amr_info__get__ncpu(self._handle)
    
    @ncpu.setter
    def ncpu(self, ncpu):
        _amr2_pkg.f90wrap_amr_info__set__ncpu(self._handle, ncpu)
    ...
    def ndim(self):
        ...
        """
        return _amr2_pkg.f90wrap_amr_info__get__ndim(self._handle)
    
    @ndim.setter
    def ndim(self, ndim):
        _amr2_pkg.f90wrap_amr_info__set__ndim(self._handle, ndim)
    ...
    def nlevelmax(self):
        ...
        """
        return _amr2_pkg.f90wrap_amr_info__get__nlevelmax(self._handle)
    
    @nlevelmax.setter
    def nlevelmax(self, nlevelmax):
        _amr2_pkg.f90wrap_amr_info__set__nlevelmax(self._handle, nlevelmax)
    ...
    def nboundary(self):
        ...
        """
        return _amr2_pkg.f90wrap_amr_info__get__nboundary(self._handle)
    
    @nboundary.setter
    def nboundary(self, nboundary):
        _amr2_pkg.f90wrap_amr_info__set__nboundary(self._handle, nboundary)
    ...
    def twotondim(self):
        ...
        """
        return _amr2_pkg.f90wrap_amr_info__get__twotondim(self._handle)
    ...
    def levelmin(self):
        ...
        """
        return _amr2_pkg.f90wrap_amr_info__get__levelmin(self._handle)
    
    @levelmin.setter
    def levelmin(self, levelmin):
        _amr2_pkg.f90wrap_amr_info__set__levelmin(self._handle, levelmin)
    ...
    def levelmax(self):
        ...
        """
        return _amr2_pkg.f90wrap_amr_info__get__levelmax(self._handle)
    
    @levelmax.setter
    def levelmax(self, levelmax):
        _amr2_pkg.f90wrap_amr_info__set__levelmax(self._handle, levelmax)
    ...
    def lmax(self):
        ...
        """
        return _amr2_pkg.f90wrap_amr_info__get__lmax(self._handle)
    ...
    def ncpu_read(self):
        ...
        """
        return _amr2_pkg.f90wrap_amr_info__get__ncpu_read(self._handle)
    
    @ncpu_read.setter
    def ncpu_read(self, ncpu_read):
        _amr2_pkg.f90wrap_amr_info__set__ncpu_read(self._handle, ncpu_read)
    ...
    def ordering(self):
        ...
        """
        return _amr2_pkg.f90wrap_amr_info__get__ordering(self._handle)
    
    @ordering.setter
    def ordering(self, ordering):
        _amr2_pkg.f90wrap_amr_info__set__ordering(self._handle, ordering)
...
@f90wrap.runtime.register_class("amr2_pkg.sim_info")
class sim_info(f90wrap.runtime.FortranDerivedType):
    ...
    def __init__(self, handle=None):
        ...
        """
        f90wrap.runtime.FortranDerivedType.__init__(self)
        result = _amr2_pkg.f90wrap_sim_info_initialise()
        self._handle = result[0] if isinstance(result, tuple) else result
    ...
    def __del__(self):
        ...
        """
        if self._alloc:
            _amr2_pkg.f90wrap_sim_info_finalise(this=self._handle)
    ...
    def cosmo(self):
        ...
        """
        return _amr2_pkg.f90wrap_sim_info__get__cosmo(self._handle)
    
    @cosmo.setter
    def cosmo(self, cosmo):
        _amr2_pkg.f90wrap_sim_info__set__cosmo(self._handle, cosmo)
    ...
    def family(self):
        ...
        """
        return _amr2_pkg.f90wrap_sim_info__get__family(self._handle)
    
    @family.setter
    def family(self, family):
        _amr2_pkg.f90wrap_sim_info__set__family(self._handle, family)
    ...
    def dm(self):
        ...
        """
        return _amr2_pkg.f90wrap_sim_info__get__dm(self._handle)
    
    @dm.setter
    def dm(self, dm):
        _amr2_pkg.f90wrap_sim_info__set__dm(self._handle, dm)
    ...
    def hydro(self):
        ...
        """
        return _amr2_pkg.f90wrap_sim_info__get__hydro(self._handle)
    
    @hydro.setter
    def hydro(self, hydro):
        _amr2_pkg.f90wrap_sim_info__set__hydro(self._handle, hydro)
    ...
    def mhd(self):
        ...
        """
        return _amr2_pkg.f90wrap_sim_info__get__mhd(self._handle)
    
    @mhd.setter
    def mhd(self, mhd):
        _amr2_pkg.f90wrap_sim_info__set__mhd(self._handle, mhd)
    ...
    def cr(self):
        ...
        """
        return _amr2_pkg.f90wrap_sim_info__get__cr(self._handle)
    
    @cr.setter
    def cr(self, cr):
        _amr2_pkg.f90wrap_sim_info__set__cr(self._handle, cr)
    ...
    def rt(self):
        ...
        """
        return _amr2_pkg.f90wrap_sim_info__get__rt(self._handle)
    
    @rt.setter
    def rt(self, rt):
        _amr2_pkg.f90wrap_sim_info__set__rt(self._handle, rt)
    ...
    def bh(self):
        ...
        """
        return _amr2_pkg.f90wrap_sim_info__get__bh(self._handle)
    
    @bh.setter
    def bh(self, bh):
        _amr2_pkg.f90wrap_sim_info__set__bh(self._handle, bh)
    ...
    def h0(self):
        ...
        """
        return _amr2_pkg.f90wrap_sim_info__get__h0(self._handle)
    
    @h0.setter
    def h0(self, h0):
        _amr2_pkg.f90wrap_sim_info__set__h0(self._handle, h0)
    ...
    def t(self):
        ...
        """
        return _amr2_pkg.f90wrap_sim_info__get__t(self._handle)
    
    @t.setter
    def t(self, t):
        _amr2_pkg.f90wrap_sim_info__set__t(self._handle, t)
    ...
    def aexp(self):
        ...
        """
        return _amr2_pkg.f90wrap_sim_info__get__aexp(self._handle)
    
    @aexp.setter
    def aexp(self, aexp):
        _amr2_pkg.f90wrap_sim_info__set__aexp(self._handle, aexp)
    ...
    def unit_l(self):
        ...
        """
        return _amr2_pkg.f90wrap_sim_info__get__unit_l(self._handle)
    
    @unit_l.setter
    def unit_l(self, unit_l):
        _amr2_pkg.f90wrap_sim_info__set__unit_l(self._handle, unit_l)
    ...
    def unit_d(self):
        ...
        """
        return _amr2_pkg.f90wrap_sim_info__get__unit_d(self._handle)
    
    @unit_d.setter
    def unit_d(self, unit_d):
        _amr2_pkg.f90wrap_sim_info__set__unit_d(self._handle, unit_d)
    ...
    def unit_t(self):
        ...
        """
        return _amr2_pkg.f90wrap_sim_info__get__unit_t(self._handle)
    ...
    def unit_m(self):
        ...
        """
        return _amr2_pkg.f90wrap_sim_info__get__unit_m(self._handle)
    
    @unit_m.setter
    def unit_m(self, unit_m):
        _amr2_pkg.f90wrap_sim_info__set__unit_m(self._handle, unit_m)
    ...
    def omega_m(self):
        ...
        """
        return _amr2_pkg.f90wrap_sim_info__get__omega_m(self._handle)
    
    @omega_m.setter
    def omega_m(self, omega_m):
        _amr2_pkg.f90wrap_sim_info__set__omega_m(self._handle, omega_m)
    ...
    def omega_l(self):
        ...
        """
        return _amr2_pkg.f90wrap_sim_info__get__omega_l(self._handle)
    
    @omega_l.setter
    def omega_l(self, omega_l):
        _amr2_pkg.f90wrap_sim_info__set__omega_l(self._handle, omega_l)
    ...
    def omega_k(self):
        ...
        """
        return _amr2_pkg.f90wrap_sim_info__get__omega_k(self._handle)
    
    @omega_k.setter
    def omega_k(self, omega_k):
        _amr2_pkg.f90wrap_sim_info__set__omega_k(self._handle, omega_k)
    ...
    def omega_b(self):
        ...
        """
        return _amr2_pkg.f90wrap_sim_info__get__omega_b(self._handle)
    
    @omega_b.setter
    def omega_b(self, omega_b):
        _amr2_pkg.f90wrap_sim_info__set__omega_b(self._handle, omega_b)
    ...
    def time_tot(self):
        ...
        """
        return _amr2_pkg.f90wrap_sim_info__get__time_tot(self._handle)
    
    @time_tot.setter
    def time_tot(self, time_tot):
        _amr2_pkg.f90wrap_sim_info__set__time_tot(self._handle, time_tot)
    ...
    def time_simu(self):
        ...
        """
        return _amr2_pkg.f90wrap_sim_info__get__time_simu(self._handle)
    
    @time_simu.setter
    def time_simu(self, time_simu):
        _amr2_pkg.f90wrap_sim_info__set__time_simu(self._handle, time_simu)
    ...
    def n_frw(self):
        ...
        """
        return _amr2_pkg.f90wrap_sim_info__get__n_frw(self._handle)
    
    @n_frw.setter
    def n_frw(self, n_frw):
        _amr2_pkg.f90wrap_sim_info__set__n_frw(self._handle, n_frw)
...
@f90wrap.runtime.register_class("amr2_pkg.level")
class level(f90wrap.runtime.FortranDerivedType):
    ...
    def __init__(self, handle=None):
        ...
        """
        f90wrap.runtime.FortranDerivedType.__init__(self)
        result = _amr2_pkg.f90wrap_level_initialise()
        self._handle = result[0] if isinstance(result, tuple) else result
    ...
    def __del__(self):
        ...
        """
        if self._alloc:
            _amr2_pkg.f90wrap_level_finalise(this=self._handle)
    ...
    def ilevel(self):
        ...
        """
        return _amr2_pkg.f90wrap_level__get__ilevel(self._handle)
    
    @ilevel.setter
    def ilevel(self, ilevel):
        _amr2_pkg.f90wrap_level__set__ilevel(self._handle, ilevel)
    ...
    def ngrid(self):
        ...
        """
        return _amr2_pkg.f90wrap_level__get__ngrid(self._handle)
    
    @ngrid.setter
    def ngrid(self, ngrid):
        _amr2_pkg.f90wrap_level__set__ngrid(self._handle, ngrid)
    ...
    def imin(self):
        ...
        """
        return _amr2_pkg.f90wrap_level__get__imin(self._handle)
    
    @imin.setter
    def imin(self, imin):
        _amr2_pkg.f90wrap_level__set__imin(self._handle, imin)
    ...
    def imax(self):
        ...
        """
        return _amr2_pkg.f90wrap_level__get__imax(self._handle)
    
    @imax.setter
    def imax(self, imax):
        _amr2_pkg.f90wrap_level__set__imax(self._handle, imax)
    ...
    def jmin(self):
        ...
        """
        return _amr2_pkg.f90wrap_level__get__jmin(self._handle)
    
    @jmin.setter
    def jmin(self, jmin):
        _amr2_pkg.f90wrap_level__set__jmin(self._handle, jmin)
    ...
    def jmax(self):
        ...
        """
        return _amr2_pkg.f90wrap_level__get__jmax(self._handle)
    
    @jmax.setter
    def jmax(self, jmax):
        _amr2_pkg.f90wrap_level__set__jmax(self._handle, jmax)
    ...
    def kmin(self):
        ...
        """
        return _amr2_pkg.f90wrap_level__get__kmin(self._handle)
    
    @kmin.setter
    def kmin(self, kmin):
        _amr2_pkg.f90wrap_level__set__kmin(self._handle, kmin)
    ...
    def kmax(self):
        ...
        """
        return _amr2_pkg.f90wrap_level__get__kmax(self._handle)
    
    @kmax.setter
    def kmax(self, kmax):
        _amr2_pkg.f90wrap_level__set__kmax(self._handle, kmax)
...
@f90wrap.runtime.register_class("amr2_pkg.data_handler")
class data_handler(f90wrap.runtime.FortranDerivedType):
    ...
    def __init__(self, handle=None):
        ...
        """
        f90wrap.runtime.FortranDerivedType.__init__(self)
        result = _amr2_pkg.f90wrap_data_handler_initialise()
        self._handle = result[0] if isinstance(result, tuple) else result
    ...
    def __del__(self):
        ...
        """
        if self._alloc:
            _amr2_pkg.f90wrap_data_handler_finalise(this=self._handle)
    ...
    def name(self):
        ...
        """
        return _amr2_pkg.f90wrap_data_handler__get__name(self._handle)
    
    @name.setter
    def name(self, name):
        _amr2_pkg.f90wrap_data_handler__set__name(self._handle, name)
    ...
    def x_data(self):
        ...
        """
        return _amr2_pkg.f90wrap_data_handler__get__x_data(self._handle)
    
    @x_data.setter
    def x_data(self, x_data):
        _amr2_pkg.f90wrap_data_handler__set__x_data(self._handle, x_data)
    ...
    def y_data(self):
        ...
        """
        return _amr2_pkg.f90wrap_data_handler__get__y_data(self._handle)
    
    @y_data.setter
    def y_data(self, y_data):
        _amr2_pkg.f90wrap_data_handler__set__y_data(self._handle, y_data)
    ...
    def z_data(self):
        ...
        """
        return _amr2_pkg.f90wrap_data_handler__get__z_data(self._handle)
    
    @z_data.setter
    def z_data(self, z_data):
        _amr2_pkg.f90wrap_data_handler__set__z_data(self._handle, z_data)
    ...
    def nx(self):
        ...
        """
        array_ndim, array_type, array_shape, array_handle = \
            _amr2_pkg.f90wrap_data_handler__array__nx(self._handle)
        if array_handle in self._arrays:
            nx = self._arrays[array_handle]
        else:
            nx = f90wrap.runtime.get_array(f90wrap.runtime.sizeof_fortran_t,
                                    self._handle,
                                    _amr2_pkg.f90wrap_data_handler__array__nx)
    ...
    def ny(self):
        ...
        """
        array_ndim, array_type, array_shape, array_handle = \
            _amr2_pkg.f90wrap_data_handler__array__ny(self._handle)
        if array_handle in self._arrays:
            ny = self._arrays[array_handle]
        else:
            ny = f90wrap.runtime.get_array(f90wrap.runtime.sizeof_fortran_t,
                                    self._handle,
                                    _amr2_pkg.f90wrap_data_handler__array__ny)
    ...
    def nz(self):
        ...
        """
        array_ndim, array_type, array_shape, array_handle = \
            _amr2_pkg.f90wrap_data_handler__array__nz(self._handle)
        if array_handle in self._arrays:
            nz = self._arrays[array_handle]
        else:
            nz = f90wrap.runtime.get_array(f90wrap.runtime.sizeof_fortran_t,
                                    self._handle,
                                    _amr2_pkg.f90wrap_data_handler__array__nz)
    ...
    def x(self):
        ...
        """
        array_ndim, array_type, array_shape, array_handle = \
            _amr2_pkg.f90wrap_data_handler__array__x(self._handle)
        if array_handle in self._arrays:
            x = self._arrays[array_handle]
        else:
            x = f90wrap.runtime.get_array(f90wrap.runtime.sizeof_fortran_t,
                                    self._handle,
                                    _amr2_pkg.f90wrap_data_handler__array__x)
    ...
    def y(self):
        ...
        """
        array_ndim, array_type, array_shape, array_handle = \
            _amr2_pkg.f90wrap_data_handler__array__y(self._handle)
        if array_handle in self._arrays:
            y = self._arrays[array_handle]
        else:
            y = f90wrap.runtime.get_array(f90wrap.runtime.sizeof_fortran_t,
                                    self._handle,
                                    _amr2_pkg.f90wrap_data_handler__array__y)
    ...
    def z(self):
        ...
        """
        array_ndim, array_type, array_shape, array_handle = \
            _amr2_pkg.f90wrap_data_handler__array__z(self._handle)
        if array_handle in self._arrays:
            z = self._arrays[array_handle]
        else:
            z = f90wrap.runtime.get_array(f90wrap.runtime.sizeof_fortran_t,
                                    self._handle,
                                    _amr2_pkg.f90wrap_data_handler__array__z)
...
@f90wrap.runtime.register_class("amr2_pkg.particle")
class particle(f90wrap.runtime.FortranDerivedType):
    ...
    def __init__(self, handle=None):
        ...
        """
        f90wrap.runtime.FortranDerivedType.__init__(self)
        result = _amr2_pkg.f90wrap_particle_initialise()
        self._handle = result[0] if isinstance(result, tuple) else result
    ...
    def __del__(self):
        ...
        """
        if self._alloc:
            _amr2_pkg.f90wrap_particle_finalise(this=self._handle)
    ...
    def id(self):
        ...
        """
        return _amr2_pkg.f90wrap_particle__get__id(self._handle)
    
    @id.setter
    def id(self, id):
        _amr2_pkg.f90wrap_particle__set__id(self._handle, id)
    ...
    def x(self):
        ...
        """
        x_handle = _amr2_pkg.f90wrap_particle__get__x(self._handle)
    ...
    def x(self, x):
        x = x._handle
        _amr2_pkg.f90wrap_particle__set__x(self._handle, x)
    ...
    def v(self):
        ...
        """
        v_handle = _amr2_pkg.f90wrap_particle__get__v(self._handle)
    ...
    def v(self, v):
        v = v._handle
        _amr2_pkg.f90wrap_particle__set__v(self._handle, v)
    ...
    def m(self):
        ...
        """
        return _amr2_pkg.f90wrap_particle__get__m(self._handle)
    
    @m.setter
    def m(self, m):
        _amr2_pkg.f90wrap_particle__set__m(self._handle, m)
    ...
    def met(self):
        ...
        """
        return _amr2_pkg.f90wrap_particle__get__met(self._handle)
    
    @met.setter
    def met(self, met):
        _amr2_pkg.f90wrap_particle__set__met(self._handle, met)
    ...
    def imass(self):
        ...
        """
        return _amr2_pkg.f90wrap_particle__get__imass(self._handle)
    
    @imass.setter
    def imass(self, imass):
        _amr2_pkg.f90wrap_particle__set__imass(self._handle, imass)
    ...
    def age(self):
        ...
        """
        return _amr2_pkg.f90wrap_particle__get__age(self._handle)
    
    @age.setter
    def age(self, age):
        _amr2_pkg.f90wrap_particle__set__age(self._handle, age)
    ...
    def tform(self):
        ...
        """
        return _amr2_pkg.f90wrap_particle__get__tform(self._handle)
    
    @tform.setter
    def tform(self, tform):
        _amr2_pkg.f90wrap_particle__set__tform(self._handle, tform)
...
def title(n, nchar):
    ...
    """
    _amr2_pkg.f90wrap_title(n=n, nchar=nchar)
...
def hilbert3d(x, y, z, order, bit_length, npoint):
    ...
    """
    _amr2_pkg.f90wrap_hilbert3d(x=x, y=y, z=z, order=order, bit_length=bit_length, \
        npoint=npoint)
...
def check_lmax(ngridfile, amr):
    ...
    """
    _amr2_pkg.f90wrap_check_lmax(ngridfile=ngridfile, amr=amr._handle)
...
def check_families(repository, sim):
    ...
    """
    _amr2_pkg.f90wrap_check_families(repository=repository, sim=sim._handle)
...
def getvarvalue(self, reg, dx, x, var, varname, value):
    ...
    Defined at read_amr_module.fpp lines 482-738
    ...
    """
    _amr2_pkg.f90wrap_getvarvalue(varids=self._handle, reg=reg._handle, dx=dx, \
...
def init_amr_read(repository, amr, sim):
    ...
    Defined at read_amr_module.fpp lines 747-835
    ...
    """
    _amr2_pkg.f90wrap_init_amr_read(repository=repository, amr=amr._handle, \
        sim=sim._handle)
...
def get_cpu_map(self, amr):
    ...
    Defined at read_amr_module.fpp lines 843-932
    ...
    """
    _amr2_pkg.f90wrap_get_cpu_map(reg=self._handle, amr=amr._handle)
...
def getparttype(self, ptype):
    ...
    Defined at read_amr_module.fpp lines 934-942
...
def getpartvalue(self, reg, part, var, value, dx=None):
    ...
    Defined at read_amr_module.fpp lines 944-1340
