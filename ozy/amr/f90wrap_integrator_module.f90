! Module amr_integrator defined in file integrator_module.fpp

subroutine f90wrap_amr_region_attrs__get__nvars(this, f90wrap_nvars)
...
end subroutine f90wrap_amr_region_attrs__get__nvars

subroutine f90wrap_amr_region_attrs__set__nvars(this, f90wrap_nvars)
    use amr_integrator, only: amr_region_attrs
    implicit none
    type amr_region_attrs_ptr_type
        type(amr_region_attrs), pointer :: p => NULL()
...
end subroutine f90wrap_amr_region_attrs__array__varnames

subroutine f90wrap_amr_region_attrs__get__nwvars(this, f90wrap_nwvars)
    use amr_integrator, only: amr_region_attrs
    implicit none
    type amr_region_attrs_ptr_type
        type(amr_region_attrs), pointer :: p => NULL()
...
end subroutine f90wrap_amr_region_attrs__get__nwvars

subroutine f90wrap_amr_region_attrs__set__nwvars(this, f90wrap_nwvars)
    use amr_integrator, only: amr_region_attrs
    implicit none
    type amr_region_attrs_ptr_type
        type(amr_region_attrs), pointer :: p => NULL()
...
end subroutine f90wrap_amr_region_attrs__array__wvarnames

subroutine f90wrap_amr_region_attrs__array__data(this, nd, dtype, dshape, dloc)
    use amr_integrator, only: amr_region_attrs
    implicit none
    type amr_region_attrs_ptr_type
        type(amr_region_attrs), pointer :: p => NULL()
...
end subroutine f90wrap_amr_region_attrs__array__data

subroutine f90wrap_amr_region_attrs_initialise(this)
    use amr_integrator, only: amr_region_attrs
    implicit none
...
end subroutine f90wrap_amr_region_attrs_initialise

subroutine f90wrap_amr_region_attrs_finalise(this)
    use amr_integrator, only: amr_region_attrs
    implicit none
