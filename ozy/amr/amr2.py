...
class Export_Amr(f90wrap.runtime.FortranModule):
    """
    Module export_amr
    ...
    """
    @f90wrap.runtime.register_class("amr2.chunk_handler")
    class chunk_handler(f90wrap.runtime.FortranDerivedType):
        ...
        def __init__(self, handle=None):
            ...
            """
            f90wrap.runtime.FortranDerivedType.__init__(self)
            result = _amr2.f90wrap_chunk_handler_initialise()
            self._handle = result[0] if isinstance(result, tuple) else result
        ...
        def __del__(self):
            ...
            """
            if self._alloc:
                _amr2.f90wrap_chunk_handler_finalise(this=self._handle)
        ...
        def nvars(self):
            ...
            """
            return _amr2.f90wrap_chunk_handler__get__nvars(self._handle)
        
        @nvars.setter
        def nvars(self, nvars):
            _amr2.f90wrap_chunk_handler__set__nvars(self._handle, nvars)
        ...
        def nx(self):
            ...
            """
            return _amr2.f90wrap_chunk_handler__get__nx(self._handle)
        
        @nx.setter
        def nx(self, nx):
            _amr2.f90wrap_chunk_handler__set__nx(self._handle, nx)
        ...
        def ny(self):
            ...
            """
            return _amr2.f90wrap_chunk_handler__get__ny(self._handle)
        
        @ny.setter
        def ny(self, ny):
            _amr2.f90wrap_chunk_handler__set__ny(self._handle, ny)
        ...
        def nz(self):
            ...
            """
            return _amr2.f90wrap_chunk_handler__get__nz(self._handle)
        
        @nz.setter
        def nz(self, nz):
            _amr2.f90wrap_chunk_handler__set__nz(self._handle, nz)
        ...
        def varnames(self):
            ...
            """
            array_ndim, array_type, array_shape, array_handle = \
                _amr2.f90wrap_chunk_handler__array__varnames(self._handle)
            if array_handle in self._arrays:
                varnames = self._arrays[array_handle]
            else:
                varnames = f90wrap.runtime.get_array(f90wrap.runtime.sizeof_fortran_t,
                                        self._handle,
                                        _amr2.f90wrap_chunk_handler__array__varnames)
                self._arrays[array_handle] = varnames
            return varnames
        ...
        def filt(self):
            ...
            """
            filt_handle = _amr2.f90wrap_chunk_handler__get__filt(self._handle)
            if tuple(filt_handle) in self._objs:
                filt = self._objs[tuple(filt_handle)]
            else:
                filt = filtering.filter.from_handle(filt_handle)
        ...
        def filt(self, filt):
            filt = filt._handle
            _amr2.f90wrap_chunk_handler__set__filt(self._handle, filt)
        ...
        def data(self):
            ...
            """
            array_ndim, array_type, array_shape, array_handle = \
                _amr2.f90wrap_chunk_handler__array__data(self._handle)
            if array_handle in self._arrays:
                data = self._arrays[array_handle]
            else:
                data = f90wrap.runtime.get_array(f90wrap.runtime.sizeof_fortran_t,
                                        self._handle,
                                        _amr2.f90wrap_chunk_handler__array__data)
                self._arrays[array_handle] = data
            return data
    ...
    def allocate_chunk_handler(self):
        ...
        """
        _amr2.f90wrap_allocate_chunk_handler(chunk=self._handle)
    ...
    def get_unigrid_old(repository, reg, chunk):
        ...
        """
        _amr2.f90wrap_get_unigrid_old(repository=repository, reg=reg._handle, \
            chunk=chunk._handle)
    ...
    def get_unigrid(repository, reg, lmax, symlog, chunk):
        ...
        """
        _amr2.f90wrap_get_unigrid(repository=repository, reg=reg._handle, lmax=lmax, \
            symlog=symlog, chunk=chunk._handle)
    
    _dt_array_initialisers = []
    

export_amr = Export_Amr()
