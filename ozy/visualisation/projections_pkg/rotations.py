...
def euler_matrix(r, dim, angle, ap):
    ...
    """
    _projections_pkg.f90wrap_euler_matrix(r=r, dim=dim, angle=angle, ap=ap)
...
def _rotate_vector_single(self, rotation_matrix):
    ...
    """
    _projections_pkg.f90wrap_rotate_vector_single(vec=self._handle, \
...
def _rotate_vector_array(self, rotation_matrix):
    ...
    """
    _projections_pkg.f90wrap_rotate_vector_array(vec=self._handle, \
        rotation_matrix=rotation_matrix)
