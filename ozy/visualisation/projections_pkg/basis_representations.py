...
@f90wrap.runtime.register_class("projections_pkg.basis")
class basis(f90wrap.runtime.FortranDerivedType):
    ...
    def __init__(self, handle=None):
        ...
        result = _projections_pkg.f90wrap_basis_initialise()
    ...
    def __del__(self):
        ...
        """
        if self._alloc:
            _projections_pkg.f90wrap_basis_finalise(this=self._handle)
    
    def init_array_u(self):
        self.u = f90wrap.runtime.FortranDerivedTypeArray(self,
                                        _projections_pkg.f90wrap_basis__array_getitem__u,
                                        _projections_pkg.f90wrap_basis__array_setitem__u,
                                        _projections_pkg.f90wrap_basis__array_len__u,
                                        """
...
def initialise_basis(self):
    ...
    """
    _projections_pkg.f90wrap_initialise_basis(this=self._handle)
...
def mgramschmidt(self, e):
    ...
    """
    _projections_pkg.f90wrap_mgramschmidt(vecs=self._handle, e=e._handle)
