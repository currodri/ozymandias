...
class hydroID(f90wrap.runtime.FortranDerivedType):
    ...
    def cr_pressure(self):
        ...
        """
        return _projections_pkg.f90wrap_hydroid__get__cr_pressure(self._handle)
    
    @cr_pressure.setter
    def cr_pressure(self, cr_pressure):
        _projections_pkg.f90wrap_hydroid__set__cr_pressure(self._handle, cr_pressure)
...
class amr_info(f90wrap.runtime.FortranDerivedType):
    ...
    def lmin(self):
        ...
        """
        return _projections_pkg.f90wrap_amr_info__get__lmin(self._handle)
    
    @lmin.setter
    def lmin(self, lmin):
        _projections_pkg.f90wrap_amr_info__set__lmin(self._handle, lmin)
...
class sim_info(f90wrap.runtime.FortranDerivedType):
    ...
    def cosmo(self):
        ...
        """
        return _projections_pkg.f90wrap_sim_info__get__cosmo(self._handle)
    
    @cosmo.setter
    def cosmo(self, cosmo):
        _projections_pkg.f90wrap_sim_info__set__cosmo(self._handle, cosmo)
    ...
    def family(self):
        ...
        """
        return _projections_pkg.f90wrap_sim_info__get__family(self._handle)
    
    @family.setter
    def family(self, family):
        _projections_pkg.f90wrap_sim_info__set__family(self._handle, family)
    ...
    def dm(self):
        ...
        """
        return _projections_pkg.f90wrap_sim_info__get__dm(self._handle)
    
    @dm.setter
    def dm(self, dm):
        _projections_pkg.f90wrap_sim_info__set__dm(self._handle, dm)
    ...
    def hydro(self):
        ...
        """
        return _projections_pkg.f90wrap_sim_info__get__hydro(self._handle)
    
    @hydro.setter
    def hydro(self, hydro):
        _projections_pkg.f90wrap_sim_info__set__hydro(self._handle, hydro)
    ...
    def mhd(self):
        ...
        """
        return _projections_pkg.f90wrap_sim_info__get__mhd(self._handle)
    
    @mhd.setter
    def mhd(self, mhd):
        _projections_pkg.f90wrap_sim_info__set__mhd(self._handle, mhd)
    ...
    def cr(self):
        ...
        """
        return _projections_pkg.f90wrap_sim_info__get__cr(self._handle)
    
    @cr.setter
    def cr(self, cr):
        _projections_pkg.f90wrap_sim_info__set__cr(self._handle, cr)
    ...
    def rt(self):
        ...
        """
        return _projections_pkg.f90wrap_sim_info__get__rt(self._handle)
    
    @rt.setter
    def rt(self, rt):
        _projections_pkg.f90wrap_sim_info__set__rt(self._handle, rt)
    ...
    def bh(self):
        ...
        """
        return _projections_pkg.f90wrap_sim_info__get__bh(self._handle)
    
    @bh.setter
    def bh(self, bh):
        _projections_pkg.f90wrap_sim_info__set__bh(self._handle, bh)
    ...
    def unit_m(self):
        ...
        """
        return _projections_pkg.f90wrap_sim_info__get__unit_m(self._handle)
    
    @unit_m.setter
    def unit_m(self, unit_m):
        _projections_pkg.f90wrap_sim_info__set__unit_m(self._handle, unit_m)
    ...
    def boxlen(self):
        ...
        """
        return _projections_pkg.f90wrap_sim_info__get__boxlen(self._handle)
    
    @boxlen.setter
    def boxlen(self, boxlen):
        _projections_pkg.f90wrap_sim_info__set__boxlen(self._handle, boxlen)
    ...
    def time_tot(self):
        ...
        """
        return _projections_pkg.f90wrap_sim_info__get__time_tot(self._handle)
    
    @time_tot.setter
    def time_tot(self, time_tot):
        _projections_pkg.f90wrap_sim_info__set__time_tot(self._handle, time_tot)
    ...
    def time_simu(self):
        ...
        """
        return _projections_pkg.f90wrap_sim_info__get__time_simu(self._handle)
    
    @time_simu.setter
    def time_simu(self, time_simu):
        _projections_pkg.f90wrap_sim_info__set__time_simu(self._handle, time_simu)
    ...
    def n_frw(self):
        ...
        """
        return _projections_pkg.f90wrap_sim_info__get__n_frw(self._handle)
    
    @n_frw.setter
    def n_frw(self, n_frw):
        _projections_pkg.f90wrap_sim_info__set__n_frw(self._handle, n_frw)
    ...
    def aexp_frw(self):
        ...
        """
        array_ndim, array_type, array_shape, array_handle = \
            _projections_pkg.f90wrap_sim_info__array__aexp_frw(self._handle)
        if array_handle in self._arrays:
            aexp_frw = self._arrays[array_handle]
        else:
            aexp_frw = f90wrap.runtime.get_array(f90wrap.runtime.sizeof_fortran_t,
                                    self._handle,
                                    _projections_pkg.f90wrap_sim_info__array__aexp_frw)
    ...
    def hexp_frw(self):
        ...
        """
        array_ndim, array_type, array_shape, array_handle = \
            _projections_pkg.f90wrap_sim_info__array__hexp_frw(self._handle)
        if array_handle in self._arrays:
            hexp_frw = self._arrays[array_handle]
        else:
            hexp_frw = f90wrap.runtime.get_array(f90wrap.runtime.sizeof_fortran_t,
                                    self._handle,
                                    _projections_pkg.f90wrap_sim_info__array__hexp_frw)
    ...
    def tau_frw(self):
        ...
        """
        array_ndim, array_type, array_shape, array_handle = \
            _projections_pkg.f90wrap_sim_info__array__tau_frw(self._handle)
        if array_handle in self._arrays:
            tau_frw = self._arrays[array_handle]
        else:
            tau_frw = f90wrap.runtime.get_array(f90wrap.runtime.sizeof_fortran_t,
                                    self._handle,
                                    _projections_pkg.f90wrap_sim_info__array__tau_frw)
    ...
    def t_frw(self):
        ...
        """
        array_ndim, array_type, array_shape, array_handle = \
            _projections_pkg.f90wrap_sim_info__array__t_frw(self._handle)
        if array_handle in self._arrays:
            t_frw = self._arrays[array_handle]
        else:
            t_frw = f90wrap.runtime.get_array(f90wrap.runtime.sizeof_fortran_t,
                                    self._handle,
                                    _projections_pkg.f90wrap_sim_info__array__t_frw)
...
@f90wrap.runtime.register_class("projections_pkg.particle")
class particle(f90wrap.runtime.FortranDerivedType):
    ...
    def __init__(self, handle=None):
        ...
        """
        f90wrap.runtime.FortranDerivedType.__init__(self)
        result = _projections_pkg.f90wrap_particle_initialise()
        self._handle = result[0] if isinstance(result, tuple) else result
    ...
    def __del__(self):
        ...
        """
        if self._alloc:
            _projections_pkg.f90wrap_particle_finalise(this=self._handle)
    ...
    def id(self):
        ...
        """
        return _projections_pkg.f90wrap_particle__get__id(self._handle)
    
    @id.setter
    def id(self, id):
        _projections_pkg.f90wrap_particle__set__id(self._handle, id)
    ...
    def x(self):
        ...
        """
        x_handle = _projections_pkg.f90wrap_particle__get__x(self._handle)
    ...
    def x(self, x):
        x = x._handle
        _projections_pkg.f90wrap_particle__set__x(self._handle, x)
    ...
    def v(self):
        ...
        """
        v_handle = _projections_pkg.f90wrap_particle__get__v(self._handle)
    ...
    def v(self, v):
        v = v._handle
        _projections_pkg.f90wrap_particle__set__v(self._handle, v)
    ...
    def m(self):
        ...
        """
        return _projections_pkg.f90wrap_particle__get__m(self._handle)
    
    @m.setter
    def m(self, m):
        _projections_pkg.f90wrap_particle__set__m(self._handle, m)
    ...
    def met(self):
        ...
        """
        return _projections_pkg.f90wrap_particle__get__met(self._handle)
    
    @met.setter
    def met(self, met):
        _projections_pkg.f90wrap_particle__set__met(self._handle, met)
    ...
    def imass(self):
        ...
        """
        return _projections_pkg.f90wrap_particle__get__imass(self._handle)
    
    @imass.setter
    def imass(self, imass):
        _projections_pkg.f90wrap_particle__set__imass(self._handle, imass)
    ...
    def age(self):
        ...
        """
        return _projections_pkg.f90wrap_particle__get__age(self._handle)
    
    @age.setter
    def age(self, age):
        _projections_pkg.f90wrap_particle__set__age(self._handle, age)
    ...
    def tform(self):
        ...
        """
        return _projections_pkg.f90wrap_particle__get__tform(self._handle)
    
    @tform.setter
    def tform(self, tform):
        _projections_pkg.f90wrap_particle__set__tform(self._handle, tform)
...
def check_lmax(ngridfile):
    ...
    """
    _projections_pkg.f90wrap_check_lmax(ngridfile=ngridfile)
...
def check_families(repository):
    ...
    """
    _projections_pkg.f90wrap_check_families(repository=repository)
...
def read_hydrofile_descriptor_old(repository):
    ...
    """
    _projections_pkg.f90wrap_read_hydrofile_descriptor_old(repository=repository)
...
def select_from_descriptor_ids(newvar, newid):
    ...
    """
    _projections_pkg.f90wrap_select_from_descriptor_ids(newvar=newvar, newid=newid)
...
def read_hydrofile_descriptor_new(repository):
    ...
    """
    _projections_pkg.f90wrap_read_hydrofile_descriptor_new(repository=repository)
...
def getvarvalue(self, dx, x, var, varname, value):
    ...
    """
    _projections_pkg.f90wrap_getvarvalue(reg=self._handle, dx=dx, x=x._handle, \
        var=var, varname=varname, value=value)
...
def init_amr_read(repository):
    ...
    """
    _projections_pkg.f90wrap_init_amr_read(repository=repository)
...
def get_cpu_map(self):
    ...
    """
    _projections_pkg.f90wrap_get_cpu_map(reg=self._handle)
...
def getparttype(self, ptype):
    ...
    """
    _projections_pkg.f90wrap_getparttype(part=self._handle, ptype=ptype)
