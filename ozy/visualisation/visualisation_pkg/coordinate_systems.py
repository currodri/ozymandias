...
def r_sphere(self):
    ...
    """
    r_sphere = _visualisation_pkg.f90wrap_r_sphere(p=self._handle)
    return r_sphere
...
def theta_sphere(self):
    ...
    """
    theta_sphere = _visualisation_pkg.f90wrap_theta_sphere(p=self._handle)
    return theta_sphere
...
def phi_sphere(self):
    ...
    """
    phi_sphere = _visualisation_pkg.f90wrap_phi_sphere(p=self._handle)
    return phi_sphere
...
def r_cyl(self):
    ...
    """
    r_cyl = _visualisation_pkg.f90wrap_r_cyl(p=self._handle)
    return r_cyl
...
def phi_cyl(self):
    ...
    """
    phi_cyl = _visualisation_pkg.f90wrap_phi_cyl(p=self._handle)
    return phi_cyl
...
def spherical_basis_from_cartesian(self, spher_basis):
    ...
    """
    _visualisation_pkg.f90wrap_spherical_basis_from_cartesian(p=self._handle, \
...
def cylindrical_basis_from_cartesian(self, cyl_basis):
    ...
    """
    _visualisation_pkg.f90wrap_cylindrical_basis_from_cartesian(p=self._handle, \
...
def new_z_coordinates(self, transformation_matrix, errormsg):
    ...
    """
    _visualisation_pkg.f90wrap_new_z_coordinates(axis=self._handle, \
