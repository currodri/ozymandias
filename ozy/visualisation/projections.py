...
class Io_Ramses(f90wrap.runtime.FortranModule):
    ...
    class hydroID(f90wrap.runtime.FortranDerivedType):
        ...
        def cr_pressure(self):
            ...
            """
            return _projections.f90wrap_hydroid__get__cr_pressure(self._handle)
        
        @cr_pressure.setter
        def cr_pressure(self, cr_pressure):
            _projections.f90wrap_hydroid__set__cr_pressure(self._handle, cr_pressure)
    ...
    class sim_info(f90wrap.runtime.FortranDerivedType):
        ...
        def dm(self):
            ...
            """
            return _projections.f90wrap_sim_info__get__dm(self._handle)
        
        @dm.setter
        def dm(self, dm):
            _projections.f90wrap_sim_info__set__dm(self._handle, dm)
        ...
        def hydro(self):
            ...
            """
            return _projections.f90wrap_sim_info__get__hydro(self._handle)
        
        @hydro.setter
        def hydro(self, hydro):
            _projections.f90wrap_sim_info__set__hydro(self._handle, hydro)
        ...
        def mhd(self):
            ...
            """
            return _projections.f90wrap_sim_info__get__mhd(self._handle)
        
        @mhd.setter
        def mhd(self, mhd):
            _projections.f90wrap_sim_info__set__mhd(self._handle, mhd)
        ...
        def cr(self):
            ...
            """
            return _projections.f90wrap_sim_info__get__cr(self._handle)
        
        @cr.setter
        def cr(self, cr):
            _projections.f90wrap_sim_info__set__cr(self._handle, cr)
        ...
        def rt(self):
            ...
            """
            return _projections.f90wrap_sim_info__get__rt(self._handle)
        
        @rt.setter
        def rt(self, rt):
            _projections.f90wrap_sim_info__set__rt(self._handle, rt)
        ...
        def bh(self):
            ...
            """
            return _projections.f90wrap_sim_info__get__bh(self._handle)
        
        @bh.setter
        def bh(self, bh):
            _projections.f90wrap_sim_info__set__bh(self._handle, bh)
    ...
    def check_lmax(ngridfile):
        ...
        """
        _projections.f90wrap_check_lmax(ngridfile=ngridfile)
    ...
    def check_families(repository):
        ...
        """
        _projections.f90wrap_check_families(repository=repository)
    ...
    def select_from_descriptor_ids(newvar, newid):
        ...
        """
        _projections.f90wrap_select_from_descriptor_ids(newvar=newvar, newid=newid)
    ...
    def getvarvalue(self, dx, x, var, varname, value):
        ...
        """
        _projections.f90wrap_getvarvalue(reg=self._handle, dx=dx, x=x._handle, var=var, \
    ...
    def init_amr_read(repository):
        ...
        """
        _projections.f90wrap_init_amr_read(repository=repository)
    ...
    def get_cpu_map(self):
        ...
        """
        _projections.f90wrap_get_cpu_map(reg=self._handle)
    ...
    def getpartvalue(self, part, var, value, dx=None):
        ...
        """
        _projections.f90wrap_getpartvalue(reg=self._handle, part=part._handle, var=var, \
    ...
    def longint(self):
        ...
        """
        return _projections.f90wrap_io_ramses__get__longint()
    
    @longint.setter
    def longint(self, longint):
        _projections.f90wrap_io_ramses__set__longint(longint)
...
class Filtering(f90wrap.runtime.FortranModule):
    ...
    Defined at read_amr_module.fpp lines 1384-1476
    ...
    class filter(f90wrap.runtime.FortranDerivedType):
        ...
        Defined at read_amr_module.fpp lines 1387-1392
        ...
        def name(self):
            ...
            Defined at read_amr_module.fpp line 1388
        ...
        def ncond(self):
            ...
            Defined at read_amr_module.fpp line 1389
        ...
        def cond_vars(self):
            ...
            Defined at read_amr_module.fpp line 1390
        ...
        def cond_ops(self):
            ...
            Defined at read_amr_module.fpp line 1391
        ...
        def cond_vals(self):
            ...
            Defined at read_amr_module.fpp line 1392
    ...
    def allocate_filter(self):
        ...
        Defined at read_amr_module.fpp lines 1395-1400
    ...
    def cond_string_to_filter(str, filt):
        ...
        Defined at read_amr_module.fpp lines 1402-1406
    ...
    def filter_cell(self, filt, cell_x, cell_dx, cell_var):
        ...
        Defined at read_amr_module.fpp lines 1408-1440
        ...
        """
        filter_cell = _projections.f90wrap_filter_cell(reg=self._handle, \
    ...
    def filter_particle(self, filt, part, dx=None):
        ...
        Defined at read_amr_module.fpp lines 1442-1476
        ...
        """
        filter_particle = _projections.f90wrap_filter_particle(reg=self._handle, \
...
class Maps(f90wrap.runtime.FortranModule):
    ...
    Defined at ramses2map.fpp lines 194-1044
    ...
    def projection_hydro(repository, cam, bulk_velocity, proj):
        ...
        Defined at ramses2map.fpp lines 214-239
    ...
    @staticmethod
    def project_cells(repository, bbox, cam, proj):
        """
        project_cells(repository, bbox, cam, proj)
        
        
        Defined at ramses2map.fpp lines 241-534
        ...
        """
        _projections.f90wrap_project_cells(repository=repository, bbox=bbox._handle, \
            cam=cam._handle, proj=proj._handle)
    ...
    def projection_parts(repository, cam, bulk_velocity, proj, tag_file=None):
        ...
        Defined at ramses2map.fpp lines 536-560
    ...
    def project_particles(repository, bbox, cam, proj, tag_file=None):
        """
        project_particles(repository, bbox, cam, proj[, tag_file])
        
        
        Defined at ramses2map.fpp lines 562-778
        ...
        """
        _projections.f90wrap_project_particles(repository=repository, bbox=bbox._handle, \
            cam=cam._handle, proj=proj._handle, tag_file=tag_file)
    ...
    def healpix_hydro(repository, reg, nside, proj):
        ...
        Defined at ramses2map.fpp lines 780-792
    ...
    def project_cells_hpix(repository, reg, nside, proj):
        ...
        Defined at ramses2map.fpp lines 794-1044
        ...
        """
        _projections.f90wrap_project_cells_hpix(repository=repository, reg=reg._handle, \
            nside=nside, proj=proj._handle)
