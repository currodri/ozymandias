...
class Galaxy(Group):
    ...
    def _empty_galaxy(self):
        ...
        # if self.obj.simulation.physics['hydro']:
        #     self.outflows['density_20rvir'] = self.obj.yt_dataset.quan(0.0, 'code_density')
        #     self.outflows['temperature_20rvir'] = self.obj.yt_dataset.quan(0, 'code_temperature')
        #     self.outflows['massflow_rate_20rvir'] = self.obj.yt_dataset.quan(0, 'code_mass*code_velocity/code_length')
        #     self.outflows['v_20rvir'] = self.obj.yt_dataset.quan(0, 'code_velocity')
        #     self.outflows['thermal_energy_20rvir'] = self.obj.yt_dataset.quan(0, 'code_mass * code_velocity**2')
        #     self.outflows['thermal_energy_specific_20rvir'] = self.obj.yt_dataset.quan(0, 'code_specific_energy')

        #     if self.obj.simulation.physics['metals']:
        #         self.outflows['metallicity_20rvir'] = 0
        # else:
        #     self.outflows['massflow_rate_20rvir'] = self.obj.yt_dataset.quan(0.0, 'code_mass*code_velocity/code_length')
        
        # if self.obj.simulation.physics['magnetic']:
        #     if self.obj.simulation.physics['metals']:
        #         self.outflows['magnetic_energy_20rvir'] = self.obj.yt_dataset.quan(0, 'code_mass * code_velocity**2')
        #         self.outflows['magnetic_energy_specific_20rvir'] = self.obj.yt_dataset.quan(0, 'code_specific_energy')
        #     else:
        #         self.outflows['magnetic_energy_20rvir'] = self.obj.yt_dataset.quan(0, 'code_mass * code_velocity**2')
        #         self.outflows['magnetic_energy_specific_20rvir'] = self.obj.yt_dataset.quan(0, 'code_specific_energy')
        ...
        # if self.obj.simulation.physics['cr']:
        #     if self.obj.simulation.physics['metals']:
        #         self.outflows['cr_energy_20rvir'] = self.obj.yt_dataset.quan(0, 'code_mass * code_velocity**2')
        #         self.outflows['cr_energy_specific_20rvir'] = self.obj.yt_dataset.quan(0, 'code_specific_energy')
        #     else:
        #         self.outflows['cr_energy_20rvir'] = self.obj.yt_dataset.quan(0, 'code_mass * code_velocity**2')
        #         self.outflows['cr_energy_specific_20rvir'] = self.obj.yt_dataset.quan(0, 'code_specific_energy')

        # if self.obj.simulation.physics['rt']:
        #     self.outflows['xHII_20rvir'] = 0
        #     self.outflows['xHeII_20rvir'] = 0
        #     self.outflows['xHeIII_20rvir'] = 0

        # # Assign results to galaxy object
        # if self.obj.simulation.physics['hydro']:
        #     self.inflows['density_20rvir'] = self.obj.yt_dataset.quan(0, 'code_density')
        #     self.inflows['temperature_20rvir'] = self.obj.yt_dataset.quan(0, 'code_temperature')
        #     self.inflows['massflow_rate_20rvir'] = self.obj.yt_dataset.quan(0, 'code_mass*code_velocity/code_length')
        #     self.inflows['v_20rvir'] = self.obj.yt_dataset.quan(0, 'code_velocity')
        #     self.inflows['thermal_energy_20rvir'] = self.obj.yt_dataset.quan(0, 'code_mass * code_velocity**2')
        #     self.inflows['thermal_energy_specific_20rvir'] = self.obj.yt_dataset.quan(0, 'code_specific_energy')
        ...
        # if self.obj.simulation.physics['magnetic']:
        #     if self.obj.simulation.physics['metals']:
        #         self.inflows['magnetic_energy_20rvir'] = self.obj.yt_dataset.quan(0, 'code_mass * code_velocity**2')
        #         self.inflows['magnetic_energy_specific_20rvir'] = self.obj.yt_dataset.quan(0, 'code_specific_energy')
        #     else:
        #         self.inflows['magnetic_energy_20rvir'] = self.obj.yt_dataset.quan(0, 'code_mass * code_velocity**2')
        #         self.inflows['magnetic_energy_specific_20rvir'] = self.obj.yt_dataset.quan(0, 'code_specific_energy')
        ...
        # if self.obj.simulation.physics['cr']:
        #     if self.obj.simulation.physics['metals']:
        #         self.inflows['cr_energy_20rvir'] = self.obj.yt_dataset.quan(0, 'code_mass * code_velocity**2')
        #         self.inflows['cr_energy_specific_20rvir'] = self.obj.yt_dataset.quan(0, 'code_specific_energy')
        #     else:
        #         self.inflows['cr_energy_20rvir'] = self.obj.yt_dataset.quan(0, 'code_mass * code_velocity**2')
        #         self.inflows['cr_energy_specific_20rvir'] = self.obj.yt_dataset.quan(0, 'code_specific_energy')

        # if self.obj.simulation.physics['rt']:
        #     self.inflows['xHII_20rvir'] = 0
        #     self.inflows['xHeII_20rvir'] = 0
        #     self.inflows['xHeIII_20rvir'] = 0

        # # Assign results to galaxy object
        # if self.obj.simulation.physics['hydro']:
        #     self.outflows['density_50rvir'] = self.obj.yt_dataset.quan(0, 'code_density')
        #     self.outflows['temperature_50rvir'] = self.obj.yt_dataset.quan(0, 'code_temperature')
        #     self.outflows['massflow_rate_50rvir'] = self.obj.yt_dataset.quan(0, 'code_mass*code_velocity/code_length')
        #     self.outflows['v_50rvir'] = self.obj.yt_dataset.quan(0, 'code_velocity')
        #     self.outflows['thermal_energy_50rvir'] = self.obj.yt_dataset.quan(0, 'code_mass * code_velocity**2')
        #     self.outflows['thermal_energy_specific_50rvir'] = self.obj.yt_dataset.quan(0, 'code_specific_energy')

        #     if self.obj.simulation.physics['metals']:
        #         self.outflows['metallicity_50rvir'] = 0
        # else:
        #     self.outflows['massflow_rate_50rvir'] = self.obj.yt_dataset.quan(0.0, 'code_mass*code_velocity/code_length')
        
        # if self.obj.simulation.physics['magnetic']:
        #     if self.obj.simulation.physics['metals']:
        #         self.outflows['magnetic_energy_50rvir'] = self.obj.yt_dataset.quan(0, 'code_mass * code_velocity**2')
        #         self.outflows['magnetic_energy_specific_50rvir'] = self.obj.yt_dataset.quan(0, 'code_specific_energy')
        #     else:
        #         self.outflows['magnetic_energy_50rvir'] = self.obj.yt_dataset.quan(0, 'code_mass * code_velocity**2')
        #         self.outflows['magnetic_energy_specific_50rvir'] = self.obj.yt_dataset.quan(0, 'code_specific_energy')
        ...
        # if self.obj.simulation.physics['cr']:
        #     if self.obj.simulation.physics['metals']:
        #         self.outflows['cr_energy_50rvir'] = self.obj.yt_dataset.quan(0, 'code_mass * code_velocity**2')
        #         self.outflows['cr_energy_specific_50rvir'] = self.obj.yt_dataset.quan(0, 'code_specific_energy')
        #     else:
        #         self.outflows['cr_energy_50rvir'] = self.obj.yt_dataset.quan(0, 'code_mass * code_velocity**2')
        #         self.outflows['cr_energy_specific_50rvir'] = self.obj.yt_dataset.quan(0, 'code_specific_energy')

        # if self.obj.simulation.physics['rt']:
        #     self.outflows['xHII_50rvir'] = 0
        #     self.outflows['xHeII_50rvir'] = 0
        #     self.outflows['xHeIII_50rvir'] = 0

        # # Assign results to galaxy object
        # if self.obj.simulation.physics['hydro']:
        #     self.inflows['density_50rvir'] = self.obj.yt_dataset.quan(0, 'code_density')
        #     self.inflows['temperature_50rvir'] = self.obj.yt_dataset.quan(0, 'code_temperature')
        #     self.inflows['massflow_rate_50rvir'] = self.obj.yt_dataset.quan(0, 'code_mass*code_velocity/code_length')
        #     self.inflows['v_50rvir'] = self.obj.yt_dataset.quan(0, 'code_velocity')
        #     self.inflows['thermal_energy_50rvir'] = self.obj.yt_dataset.quan(0, 'code_mass * code_velocity**2')
        #     self.inflows['thermal_energy_specific_50rvir'] = self.obj.yt_dataset.quan(0, 'code_specific_energy')
        ...
        # if self.obj.simulation.physics['magnetic']:
        #     if self.obj.simulation.physics['metals']:
        #         self.inflows['magnetic_energy_50rvir'] = self.obj.yt_dataset.quan(0, 'code_mass * code_velocity**2')
        #         self.inflows['magnetic_energy_specific_50rvir'] = self.obj.yt_dataset.quan(0, 'code_specific_energy')
        #     else:
        #         self.inflows['magnetic_energy_50rvir'] = self.obj.yt_dataset.quan(0, 'code_mass * code_velocity**2')
        #         self.inflows['magnetic_energy_specific_50rvir'] = self.obj.yt_dataset.quan(0, 'code_specific_energy')
        ...
        # if self.obj.simulation.physics['cr']:
        #     if self.obj.simulation.physics['metals']:
        #         self.inflows['cr_energy_50rvir'] = self.obj.yt_dataset.quan(0, 'code_mass * code_velocity**2')
        #         self.inflows['cr_energy_specific_50rvir'] = self.obj.yt_dataset.quan(0, 'code_specific_energy')
        #     else:
        #         self.inflows['cr_energy_50rvir'] = self.obj.yt_dataset.quan(0, 'code_mass * code_velocity**2')
        #         self.inflows['cr_energy_specific_50rvir'] = self.obj.yt_dataset.quan(0, 'code_specific_energy')

        # if self.obj.simulation.physics['rt']:
        #     self.inflows['xHII_50rvir'] = 0
        #     self.inflows['xHeII_50rvir'] = 0
        #     self.inflows['xHeIII_50rvir'] = 0

        # # Assign results to galaxy object
        # if self.obj.simulation.physics['hydro']:
        #     self.outflows['density_100rvir'] = self.obj.yt_dataset.quan(0, 'code_density')
        #     self.outflows['temperature_100rvir'] = self.obj.yt_dataset.quan(0, 'code_temperature')
        #     self.outflows['massflow_rate_100rvir'] = self.obj.yt_dataset.quan(0, 'code_mass*code_velocity/code_length')
        #     self.outflows['v_100rvir'] = self.obj.yt_dataset.quan(0, 'code_velocity')
        #     self.outflows['thermal_energy_100rvir'] = self.obj.yt_dataset.quan(0, 'code_mass * code_velocity**2')
        #     self.outflows['thermal_energy_specific_100rvir'] = self.obj.yt_dataset.quan(0, 'code_specific_energy')

        #     if self.obj.simulation.physics['metals']:
        #         self.outflows['metallicity_100rvir'] = 0
        # else:
        #     self.outflows['massflow_rate_100rvir'] = self.obj.yt_dataset.quan(0.0, 'code_mass*code_velocity/code_length')
        
        # if self.obj.simulation.physics['magnetic']:
        #     if self.obj.simulation.physics['metals']:
        #         self.outflows['magnetic_energy_100rvir'] = self.obj.yt_dataset.quan(0, 'code_mass * code_velocity**2')
        #         self.outflows['magnetic_energy_specific_100rvir'] = self.obj.yt_dataset.quan(0, 'code_specific_energy')
        #     else:
        #         self.outflows['magnetic_energy_100rvir'] = self.obj.yt_dataset.quan(0, 'code_mass * code_velocity**2')
        #         self.outflows['magnetic_energy_specific_100rvir'] = self.obj.yt_dataset.quan(0, 'code_specific_energy')
        ...
        # if self.obj.simulation.physics['cr']:
        #     if self.obj.simulation.physics['metals']:
        #         self.outflows['cr_energy_100rvir'] = self.obj.yt_dataset.quan(0, 'code_mass * code_velocity**2')
        #         self.outflows['cr_energy_specific_100rvir'] = self.obj.yt_dataset.quan(0, 'code_specific_energy')
        #     else:
        #         self.outflows['cr_energy_100rvir'] = self.obj.yt_dataset.quan(0, 'code_mass * code_velocity**2')
        #         self.outflows['cr_energy_specific_100rvir'] = self.obj.yt_dataset.quan(0, 'code_specific_energy')

        # if self.obj.simulation.physics['rt']:
        #     self.outflows['xHII_100rvir'] = 0
        #     self.outflows['xHeII_100rvir'] = 0
        #     self.outflows['xHeIII_100rvir'] = 0

        # # Assign results to galaxy object
        # if self.obj.simulation.physics['hydro']:
        #     self.inflows['density_100rvir'] = self.obj.yt_dataset.quan(0, 'code_density')
        #     self.inflows['temperature_100rvir'] = self.obj.yt_dataset.quan(0, 'code_temperature')
        #     self.inflows['massflow_rate_100rvir'] = self.obj.yt_dataset.quan(0, 'code_mass*code_velocity/code_length')
        #     self.inflows['v_100rvir'] = self.obj.yt_dataset.quan(0, 'code_velocity')
        #     self.inflows['thermal_energy_100rvir'] = self.obj.yt_dataset.quan(0, 'code_mass * code_velocity**2')
        #     self.inflows['thermal_energy_specific_100rvir'] = self.obj.yt_dataset.quan(0, 'code_specific_energy')
        ...
        # if self.obj.simulation.physics['magnetic']:
        #     if self.obj.simulation.physics['metals']:
        #         self.inflows['magnetic_energy_100rvir'] = self.obj.yt_dataset.quan(0, 'code_mass * code_velocity**2')
        #         self.inflows['magnetic_energy_specific_100rvir'] = self.obj.yt_dataset.quan(0, 'code_specific_energy')
        #     else:
        #         self.inflows['magnetic_energy_100rvir'] = self.obj.yt_dataset.quan(0, 'code_mass * code_velocity**2')
        #         self.inflows['magnetic_energy_specific_100rvir'] = self.obj.yt_dataset.quan(0, 'code_specific_energy')
        ...
        # if self.obj.simulation.physics['cr']:
        #     if self.obj.simulation.physics['metals']:
        #         self.inflows['cr_energy_100rvir'] = self.obj.yt_dataset.quan(0, 'code_mass * code_velocity**2')
        #         self.inflows['cr_energy_specific_100rvir'] = self.obj.yt_dataset.quan(0, 'code_specific_energy')
        #     else:
        #         self.inflows['cr_energy_100rvir'] = self.obj.yt_dataset.quan(0, 'code_mass * code_velocity**2')
        #         self.inflows['cr_energy_specific_100rvir'] = self.obj.yt_dataset.quan(0, 'code_specific_energy')

        # if self.obj.simulation.physics['rt']:
        #     self.inflows['xHII_100rvir'] = 0
        #     self.inflows['xHeII_100rvir'] = 0
        #     self.inflows['xHeIII_100rvir'] = 0
