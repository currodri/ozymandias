...
grid_variables = dict(
    ...
    smallC_density = {'unit':'code_density','neighbour':False},
    largeC_density = {'unit':'code_density','neighbour':False},
    smallSil_density = {'unit':'code_density','neighbour':False},
    largeSil_density = {'unit':'code_density','neighbour':False},
    sigma2 = {'unit':'code_velocity**2','neighbour':False},
    dust_mass = {'unit':'code_mass','neighbour':False},
    smallC_mass = {'unit':'code_mass','neighbour':False},
    largeC_mass = {'unit':'code_mass','neighbour':False},
    smallSil_mass = {'unit':'code_mass','neighbour':False},
    largeSil_mass = {'unit':'code_mass','neighbour':False}
)
