common_variables = dict(
    ...
    v_magnitude = 'code_velocity',
    v_squared = 'code_velocity*code_velocity',
    ...
    momentum_cyl_z = 'code_mass*code_velocity',
...
grid_variables = dict(
    ...
    grad_therprsphere = 'code_pressure/code_length',
    grad_therpz = 'code_pressure/code_length',
    ...
    magnetic_energy_density = 'code_energy_density',
    magnetic_pressure = 'code_pressure',
    cr_energy = 'code_energy',
    cr_energy_density = 'code_energy_density',
    cr_pressure = 'code_pressure',
    grad_crp = 'code_pressure/code_length',
    grad_crprsphere = 'code_pressure/code_length',
    grad_crpz = 'code_pressure/code_length',
    cr_energy_specific = 'code_specific_energy',
    cr_temperature_eff = 'code_temperature',
    cr_GH08heat = 'code_energy_density/code_time',
    streaming_heating = 'code_energy_density/code_time',
    grav_crpf = 'dimensionless',
    grav_crpfz = 'dimensionless',
    grav_therpfz = 'dimensionless',
    grav_crpfrsphere = 'dimensionless',
    grav_therpfrsphere = 'dimensionless',
    grav_gz = 'code_specific_energy/code_length',
    grav_frsphere = 'code_pressure/code_length',
