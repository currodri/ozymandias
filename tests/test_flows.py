...
proj = do_projection(gal,['gas/density','gas/temperature','gas/v_sphere_r','gas/v_sphere_r',
                            'gas/grav_therpfrsphere','gas/grav_crpfrsphere'],window=(0.25,'rvir'),pov='edgeon',
                    filter_conds=['none','v_sphere_r/>/10/km*s**-1','v_sphere_r/<=/-20/km*s**-1'],
                    filter_name=['all','outflow','inflow'],weight=['gas/massflux_rate_sphere_r','star/cumulative'])
proj.save_FITS('NUT_00035_edgeon.fits')
# plot_single_galaxy_projection('NUT_00035_edgeon.fits',['gas/density','gas/temperature','gas/v_sphere_r','gas/v_sphere_r',
