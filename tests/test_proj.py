...
plot_single_galaxy_projection('NUT_00035_y.fits',['gas/density','gas/temperature','star/sdensity',
                                                  'gas/neighbour_accuracy','gas/grad_crp','gas/eff_FKmag'])
proj = do_projection(gal,['gas/density','gas/temperature','gas/v_cyl_z','gas/v_sphere_r','gas/alfvendiff_ratio','gas/grav_crpfrsphere','gas/sigma','gas/grav_therpfz'],window=(0.1,'rvir'),pov='edgeon',weight=['gas/density','star/cumulative'])
proj.save_FITS('NUT_00035_edgeon.fits')
plot_single_galaxy_projection('NUT_00035_edgeon.fits',['gas/density','gas/temperature','gas/v_cyl_z','gas/v_sphere_r','gas/alfvendiff_ratio','gas/grav_crpfrsphere','gas/sigma','gas/grav_therpfz'],type_scale='galaxy')
