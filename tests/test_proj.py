...
# proj = do_projection(gal,['gas/density','gas/temperature','gas/metallicity','gas/v_sphere_r','star/sdensity','star/sfr_surface_100'],window=(10,'kpc'),pov='faceon')

# proj.save_FITS('NUT_00010_faceon.fits')

# plot_single_galaxy_projection('NUT_00010_faceon.fits',['gas/density','gas/temperature','gas/metallicity','gas/v_sphere_r','star/sdensity','star/sfr_surface_100'])
